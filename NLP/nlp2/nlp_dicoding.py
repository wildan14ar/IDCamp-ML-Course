...
padded_latih = pad_sequences(sequences_latih, padding='post', maxlen=5, truncating='post')
padded_test = pad_sequences(sequences_test, padding='post', maxlen=5, truncating='post')
